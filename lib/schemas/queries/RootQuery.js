  ...
  fields: () => ({
    ...
    addLogById: {
      ...
      args: {
        ...
        careDate: { type: GraphQLNonNull(GraphQLInt) },
        careType: { type: GraphQLNonNull(GraphQLString) },
        careNote: { type: GraphQLNonNull(GraphQLString) },
      },
      resolve: (parent, args) => addLogById(args.userId, args.plantId, args.userPlantId, args.careDate, args.careType, args.careNote),
    },
    removeLogByLogId: {
      type: CareLogType,
      args: {
